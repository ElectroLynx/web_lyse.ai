...
import { C as p, a as m, r as ne, t as re } from "./motion.uzrgujnr.mjs";
import {
  C as h,
  E as g,
  P as _,
...
var w,
  ...
  me = e(() => {
    (d(),
      ...
      (F.displayName = `Text`),
      h(F, {
        Z1QnXqTEb: { defaultValue: `rgb(0, 0, 0)`, hidden: !1, title: `Fill`, type: C.Color },
        vtL2DrqsL: { defaultValue: `rgb(0, 0, 0)`, hidden: !0, title: `Fill 2`, type: C.Color },
      }));
  }),
  I,
  L,
...
e(() => {
  (d(),
    ...
    (W = _(U)),
    (G = _(F)),
    (K = S(F, { nodeId: `pBR1Ew0r8`, override: fe, scopeId: `PX9hIOIVM` })),
    (q = le(x(S(p.a, { nodeId: `HK2sXlagE`, override: de, scopeId: `PX9hIOIVM` })))),
    (J = `framer-6jWyo`),
    ...
    (Q = b(
      c(function (e, t) {
        ...
        se();
        let { style: l, className: d, layoutId: ee, variant: f, ...m } = xe(e),
          {
            baseVariant: re,
            classNames: h,
            ...
            setVariant: le,
            variants: x,
          } = oe({ defaultVariant: `HK2sXlagE`, ref: i, variant: f, variantClassNames: Y }),
          S = Se(e, x),
          C = g(J);
        return s(ne, {
          id: ee ?? a,
            ...
            children: s(ye, {
              ...
              children: s(ae, {
                ...
                children: u(q, {
                  ...
                  __targetOpacity: 1,
                  className: `${g(C, `framer-n0ccwk`, d, h)} framer-bmpgw8`,
    ...
    v(Q, [{ explicitInter: !0, fonts: [] }, ...W, ...G], { supportsExplicitInterCodegen: !0 }),
    ($ = {
      exports: {
...
//# sourceMappingURL=PX9hIOIVM.BFNgzVeO.mjs.map
